...
#define REARALS 0x92
#define REARALS_IOCTL_INIT _IOW(REARALS, 0x01, int)
#define REARALS_IOCTL_READ_SENSORDATA _IOR(REARALS, 0x02, struct SENSOR_DATA)
#define REARALS_IOCTL_GET_CALI  _IOR(REARALS, 0x03, int)
#define REARALS_IOCTL_ENABLE_CALI _IO(REARALS, 0x04)
#define REARALS_ALS_SET_CALI _IOW(REARALS, 0x20, int)
#if IS_ENABLED(CONFIG_COMPAT)
#define COMPAT_REARALS_IOCTL_INIT _IOW(REARALS, 0x01, compat_int_t)
#define COMPAT_REARALS_IOCTL_READ_SENSORDATA _IOR(REARALS, 0x02, struct SENSOR_DATA)
#define COMPAT_REARALS_IOCTL_GET_CALI _IOR(REARALS, 0x03, struct SENSOR_DATA)
#define COMPAT_REARALS_IOCTL_ENABLE_CALI _IO(REARALS, 0x04)
#define COMPAT_REARALS_ALS_SET_CALI _IO(REARALS, 0x20)
#endif

#define REARFLK 0x93
#define REARFLK_IOCTL_INIT _IOW(REARFLK, 0x01, int)
#define REARFLK_IOCTL_READ_SENSORDATA _IOR(REARFLK, 0x02, struct SENSOR_DATA)
#define REARFLK_IOCTL_GET_CALI  _IOR(REARFLK, 0x03, struct SENSOR_DATA)
#define REARFLK_IOCTL_ENABLE_CALI _IO(REARFLK, 0x04)
#if IS_ENABLED(CONFIG_COMPAT)
#define COMPAT_REARFLK_IOCTL_INIT _IOW(REARFLK, 0x01, compat_int_t)
#define COMPAT_REARFLK_IOCTL_READ_SENSORDATA _IOR(REARFLK, 0x02, struct SENSOR_DATA)
#define COMPAT_REARFLK_IOCTL_GET_CALI _IOR(REARFLK, 0x03, struct SENSOR_DATA)
#define COMPAT_REARFLK_IOCTL_ENABLE_CALI _IO(REARFLK, 0x04)
#endif
