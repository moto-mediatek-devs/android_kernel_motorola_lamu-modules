...
static ssize_t hx9031as_raw_data_show(const struct class *class, const struct class_attribute *attr, char *buf)
{
    char *p = buf;
    int ii = 0;
...
static ssize_t hx9031as_reg_write_store(const struct class *class, const struct class_attribute *attr, const char *buf, size_t count)
{
    int ret = -1;
...
static ssize_t hx9031as_reg_read_store(const struct class *class, const struct class_attribute *attr, const char *buf, size_t count)
{
    int ret = -1;
    unsigned int reg_address = 0;
    uint8_t addr = 0;
...
static ssize_t hx9031as_channel_en_store(const struct class *class, const struct class_attribute *attr, const char *buf, size_t count)
{
    int ch_id = 0;
    int en = 0;
...
static ssize_t hx9031as_channel_en_show(const struct class *class, const struct class_attribute *attr, char *buf)
{
    int ii = 0;
    char *p = buf;
...
static ssize_t hx9031as_manual_offset_calibration_show(const struct class *class, const struct class_attribute *attr, char *buf)
{
    hx9031as_read_offset_dac();
    return sprintf(buf, "OFFSET_DAC, %-8d, %-8d, %-8d, %-8d, %-8d\n", data_offset_dac[0], data_offset_dac[1], data_offset_dac[2], data_offset_dac[3], data_offset_dac[4]);
}

static ssize_t hx9031as_manual_offset_calibration_store(const struct class *class, const struct class_attribute *attr, const char *buf, size_t count)
{
    unsigned long val;
    uint8_t ch_id = 0;
...
static ssize_t hx9031as_prox_state_show(const struct class *class, const struct class_attribute *attr, char *buf)
{
    hx9031as_get_prox_state();
    return sprintf(buf, "prox_state_reg=0x%02X\n", hx9031as_pdata.prox_state_reg);
}

static ssize_t hx9031as_polling_store(const struct class *class, const struct class_attribute *attr, const char *buf, size_t count)
{
    int value = 0;
    int ret = -1;
...
static ssize_t hx9031as_polling_show(const struct class *class, const struct class_attribute *attr, char *buf)
{
...
static ssize_t hx9031as_loglevel_show(const struct class *class, const struct class_attribute *attr, char *buf)
{
    PRINT_INF("tyhx_log_level=%d\n", tyhx_log_level);
    return sprintf(buf, "tyhx_log_level=%d\n", tyhx_log_level);
}

static ssize_t hx9031as_loglevel_store(const struct class *class, const struct class_attribute *attr, const char *buf, size_t count)
{
    int ret = -1;
    int value = 0;
...
static ssize_t hx9031as_accuracy_show(const struct class *class, const struct class_attribute *attr, char *buf)
{
    PRINT_INF("hx9031as_data_accuracy=%d\n", hx9031as_data_accuracy);
    return sprintf(buf, "hx9031as_data_accuracy=%d\n", hx9031as_data_accuracy);
}

static ssize_t hx9031as_accuracy_store(const struct class *class, const struct class_attribute *attr, const char *buf, size_t count)
{
    int ret = -1;
    int value = 0;
...
static ssize_t hx9031as_threshold_store(const struct class *class, const struct class_attribute *attr, const char *buf, size_t count)
{
    unsigned int ch = 0;
...
static ssize_t hx9031as_threshold_show(const struct class *class, const struct class_attribute *attr, char *buf)
{
    int ii = 0;
    char *p = buf;
...
static ssize_t hx9031as_dump_show(const struct class *class, const struct class_attribute *attr, char *buf)
{
    int ret = -1;
    int ii = 0;
    char *p = buf;
...
static ssize_t hx9031as_offset_dac_show(const struct class *class, const struct class_attribute *attr, char *buf)
{
    int ii = 0;
    char *p = buf;
