...
static void boe_panel_init(struct boe *ctx)
{
	...
	boe_dcs_write_seq_static(ctx, 0xC1,0x00,0x00,0x20,0x26,0x26,0x04,0x08,0x18,0x04,0x60,0x19,0x22,0x50,0x01,0x12,0x07,0x5F,0xFF,0xA0,0x00,0x93,0x10,0x10,0x00);
