...
static void boe_panel_init(struct boe *ctx)
{
	...
	boe_dcs_write_seq_static(ctx, 0x99,0x91,0x72,0x01,0x3F,0x00,0x7A,0x00,0x30,0x22,0x01,0xA2,0x00,0xB8,0x00,0x27,0x06,0x27,0x06,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00);

	boe_dcs_write_seq_static(ctx, 0xC1,0x00,0x00,0x20,0x26,0x26,0x04,0x08,0x50,0x04,0x60,0x19,0x22,0x50,0x01,0x12,0x07,0x5F,0xFF,0xA0,0x00,0x93,0x10,0x10,0x00);

	boe_dcs_write_seq_static(ctx, 0xE0,0x0C,0x00,0xB0,0x0C,0x00,0x15,0x7C,0x69,0x04);

	boe_dcs_write_seq_static(ctx, 0xD0,0x0C,0x23,0x18,0x00,0x00,0x00,0x80,0x0C,0xFF,0x0F,0x42);
	boe_dcs_write_seq_static(ctx, 0x9D,0x00,0x00,0x00,0x27,0x34,0x5B,0x68,0x90,0x54,0x61,0x6B,0x79,0x83,0x92,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00);
	boe_dcs_write_seq_static(ctx, 0xC3,0x00,0x00,0x00,0x00,0x00,0x00,0x2C,0x32,0x68,0x16,0x16,0x16,0x00,0xFF,0x40,0x4D,0x2A,0x2A,0x2A,0x2A,0x2A,0x2A,0x2A,0x2A,0x00,0x00,0x00,0x00,0x00,0x10,0x00,0x00);
	boe_dcs_write_seq_static(ctx, 0xC5,0x02,0x27,0x76,0xC8,0x52,0x00,0x02,0x02,0x0E,0x02,0x10,0x26,0x05,0x0B,0x00,0x20,0x0D,0x0A,0x0B,0x12,0x80,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00);
	boe_dcs_write_seq_static(ctx, 0xC6,0xCB,0x08,0x2E,0x46,0x46,0x20,0x3F,0x02,0x16,0x16,0x00,0x00,0x1C,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00);
	...
	boe_dcs_write_seq_static(ctx, 0x55,0x03,0x00);
	msleep(5);
	boe_dcs_write_seq_static(ctx, 0xF0,0x22,0x0C);
	boe_dcs_write_seq_static(ctx, 0xE0,0x0C,0x00,0xB0,0x0C,0x00,0x15,0x7C,0x29,0x04,0x21,0x01,0x00,0x00,0x00,0x00,0x2E,0x17,0x0C,0x98);
	boe_dcs_write_seq_static(ctx, 0xE1,0x0F,0x1F,0x2F,0x3F,0x4F,0x5F,0x6F,0x7F,0x90,0xA0,0xB0,0xC0,0xD0,0xE0,0xE8,0xEC,0xED,0xEF,0xF1,0xF8,0xF8,0xF8,0xF9,0xFB,0xFB,0xFC,0xFD,0xFE,0xFF,0xFF,0xFF);
	boe_dcs_write_seq_static(ctx, 0xE2,0x36,0x24,0x37,0x4B,0x38,0x72,0x39,0x99,0x3D,0x00,0x3C,0x0F,0x3B,0xC2,0x3B,0xA5,0x3C,0x28,0x3C,0xED,0x3D,0xB1,0x3E,0x76,0x3F,0x3A,0x3F,0xFF,0x3F,0xFF,0x3F,0xFF);
	boe_dcs_write_seq_static(ctx, 0xF0,0x00,0x00);

	boe_dcs_write_seq_static(ctx, 0x11,0x00,0x00);
	msleep(120);
	boe_dcs_write_seq_static(ctx, 0x29,0x00,0x00);
	msleep(10);
...
static int boe_unprepare(struct drm_panel *panel)
{
	...
	boe_dcs_write_seq_static(ctx, 0xF0,0x99,0x22,0x0C);
	boe_dcs_write_seq_static(ctx, 0xBB,0x01,0x02,0x03,0x0A,0x04,0x13,0x14,0x12,0x16,0x5C,0x00,0x15,0x16,0x00);
	boe_dcs_write_seq_static(ctx, 0xF0,0x00,0x00,0x00);
